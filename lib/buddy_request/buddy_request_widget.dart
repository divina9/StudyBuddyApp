...
import 'buddy_request_model.dart';
...
class _BuddyRequestWidgetState extends State<BuddyRequestWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuddyRequestModel());
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'Accept people in your StudyGroup!',
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 12.0, 0.0, 0.0),
                            child: Text(
                              'You can accept a maximum of 5 people.',
                              style: FlutterFlowTheme.of(context).labelMedium,
                            ),
                          ),
                        ),
