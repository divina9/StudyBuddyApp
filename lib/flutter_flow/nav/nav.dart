...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? DashboardWidget() : EmailAuthWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'PreferenceSettingsPage',
          path: '/preferenceSettingsPage',
          builder: (context, params) => PreferenceSettingsPageWidget(),
        ),
        FFRoute(
          name: 'Timer',
          path: '/timer',
        ...
        FFRoute(
          name: 'BuddyRequest',
          path: '/buddyRequest',
          builder: (context, params) => BuddyRequestWidget(
            userToAccept: params.getParam(
                'userToAccept', ParamType.DocumentReference, false, ['Users']),
          ),
        ),
        FFRoute(
          name: 'createaccountsuccess',
          path: '/createaccountsuccess',
          builder: (context, params) => CreateaccountsuccessWidget(),
        ),
        FFRoute(
          name: 'CreateGroup',
          path: '/createGroup',
