...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? CreateaccountWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'CreateGroupChatPagePrivate',
          path: '/createGroupChatPagePrivate',
          builder: (context, params) => CreateGroupChatPagePrivateWidget(),
        ),
        FFRoute(
          name: 'CreateGroup',
          path: '/createGroup',
